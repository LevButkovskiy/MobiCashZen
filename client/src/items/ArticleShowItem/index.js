    ...
    return (
        <div className="articleShowContent">
            ...
            <div className="tagsShow">
                ...
                <div className="isLiked" onClick={!props.preview ? addToSaved : ()=>{}}><span>{t("ADD_TO_SAVED.1")}</span><img alt="bookmarkImage" src={!isLiked ? "/images/bookmark.png" : "/images/bookmark_red.png"}/></div>
            </div>
        </div>
    );
}
